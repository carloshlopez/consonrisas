Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :facebook, '161667273881845', 'a90fc797ce1572a3e4952b4d8172f228', {:scope => 'publish_stream,email, offline_access, manage_pages, create_event', :client_options => {:ssl =>
